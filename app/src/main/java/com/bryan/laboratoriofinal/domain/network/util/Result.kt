package com.bryan.laboratoriofinal.domain.network.util


/*
ESTE ARCHIVO PUEDE SER COPIADO Y PEGADO
SIRVE PARA MANEJAR CUALQUIERA DE LOS ERRORES QUE YA FUERON DECLARADOS EN NETWORK ERROR
 */
 ...
 */
import com.bryan.laboratoriofinal.domain.network.util.Error as UtilError
